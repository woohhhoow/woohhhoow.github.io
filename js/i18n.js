...
const translations = {
    "en": {
        ...
        // --- P05: A Living Heritage ---
        "alh-meta": "Historic Garden Renewal / February 2026", "alh-title": "A LIVING HERITAGE", "alh-loc-val": "Giardini Indro Montanelli, Milan, Italy", "alh-type-val": "Historic Garden Renewal / Cultural Landscape Conservation / Urban Public Space Design", "alh-user-val": "Local Residents / Families / Visitors / Museum Users / Daily Park Users", "alh-status-val": "Academic Project / Concept", "alh-statement": "A Living Heritage explores the renewal of Giardini Indro Montanelli, one of Milan's historic public gardens. Rather than treating heritage as a fixed image, the project understands the park as a layered and evolving landscape. Through historical research, spatial analysis and a detailed study of the existing tree system, the proposal strengthens the relationship between the garden, the Natural History Museum and the surrounding urban fabric. Carefully inserted planting areas, reorganised paths and renewed public spaces preserve the park's identity while supporting contemporary civic life.", "alh-cap-1": "A historic garden renewed as a living civic landscape.", "alh-cap-2": "The garden is understood within Milan's broader urban and historical structure.", "alh-cap-3": "Paths, vegetation and built elements reveal the layered identity of the park.", "alh-cap-4": "Subtle interventions strengthen the dialogue between heritage and contemporary use.", "alh-cap-5": "Layered planting creates a renewed spatial rhythm within the historic garden.",

        // --- P06: RE:LINE ---
        "rel-meta": "Urban Regeneration / January 2026", "rel-title": "RE:LINE", "rel-loc-val": "Southern Milan Metropolitan Area, Lombardy, Italy", "rel-type-val": "Urban Regeneration / Slow Mobility Network / Ecological Corridor Design", "rel-user-val": "Local Residents / Cyclists / Pedestrians / Nearby Communities / Recreational Visitors", "rel-status-val": "Academic Project / Concept", "rel-statement": "RE:LINE transforms a disused railway corridor in southern Milan into an ecological and cultural spine. The project introduces a continuous slow-mobility network that reconnects fragmented neighbourhoods, farmland and open landscapes while preserving the spatial memory of the former railway. A revitalised quarry lake becomes a major recreational node, integrating water-accessible spaces, community gardens and wetland habitats. Along the wider corridor, repeatable landscape modules adapt to changing urban and rural conditions, turning obsolete infrastructure into a connected public landscape.", "rel-cap-1": "Transforming disused tracks into a living linear landscape.", "rel-cap-2": "A slow-mobility corridor reconnects fragmented urban and rural landscapes.", "rel-cap-3": "Railway traces, ecological buffers and public nodes form a linear network.", "rel-cap-4": "A former quarry becomes an accessible recreational landscape.", "rel-cap-5": "Active waterfront spaces transition gradually into restored wetland habitats.", "rel-cap-6": "Repeatable modules adapt the corridor to changing spatial conditions.",

        // --- P07: Orba River Sustainability ---
        "ors-meta": "Regional Landscape Planning / January 2025", "ors-title": "ORBA RIVER SUSTAINABILITY", "ors-loc-val": "Orba River Basin, Province of Alessandria, Piedmont, Italy", "ors-type-val": "Regional Landscape Planning / Ecological Restoration / Riparian Public Space Design", "ors-user-val": "Local Residents / Riparian Communities / Visitors / Cyclists / Agricultural Communities", "ors-status-val": "Academic Project / Concept", "ors-statement": "Orba River Sustainability is a regional landscape strategy for restoring the ecological baseline of the Orba River basin. Responding to fragmented habitats, flood vulnerability, agricultural pressure and disturbed extraction sites, the project establishes a continuous blue-green framework along the river corridor. Ecological restoration is combined with recreational spaces and slow-mobility connections, linking the river landscape with nearby communities. Three site-specific interventions translate the territorial strategy into local actions: the regeneration of a former mining area, a new entrance park and an inner-town green corridor.", "ors-cap-1": "A blue-green framework reconnecting river, town, and agriculture.", "ors-cap-2": "A regional corridor links river ecosystems, farmland and settlements.", "ors-cap-3": "River dynamics evolve into a continuous landscape strategy.", "ors-cap-4": "A former extraction site becomes a restored riverside landscape.", "ors-cap-5": "A new gateway reconnects the town with its agricultural edge.", "ors-cap-6": "The ecological network extends into everyday community spaces."
    },
    "cn": {
        ...
        // --- P05: A Living Heritage ---
        "alh-meta": "历史花园更新 / 2026年2月", "alh-title": "活态遗产", "alh-loc-val": "意大利米兰，蒙塔内利公共花园", "alh-type-val": "历史花园更新 / 文化景观保护 / 城市公共空间设计", "alh-user-val": "当地居民 / 家庭使用者 / 游客 / 博物馆访客 / 日常公园使用者", "alh-status-val": "学术项目 / 概念提案", "alh-statement": "A Living Heritage 聚焦于米兰历史公共花园 Giardini Indro Montanelli 的更新设计。项目并未将遗产视为静态保存的对象，而是将公园理解为一个持续演变、不断叠加的城市景观。通过历史资料研究、空间结构分析与现状树木系统梳理，设计重新强化花园、自然历史博物馆与周边城市环境之间的联系。新的植物空间、路径组织与公共活动区域以克制的方式嵌入既有格局，在保留历史特征的同时，使公园重新适应当代城市生活。", "alh-cap-1": "将历史花园更新为持续生长的城市公共景观。", "alh-cap-2": "从米兰城市与历史结构中重新理解这座花园。", "alh-cap-3": "路径、植被与建筑元素共同呈现公园的历史层积。", "alh-cap-4": "克制的更新方式强化历史空间与当代使用之间的联系。", "alh-cap-5": "层次丰富的植物设计重塑历史花园的空间节奏。",

        // --- P06: RE:LINE ---
        "rel-meta": "城市更新 / 2026年1月", "rel-title": "重构线性连接", "rel-loc-val": "意大利伦巴第大区，米兰南部都市边缘地区", "rel-type-val": "城市更新 / 慢行网络设计 / 生态廊道设计", "rel-user-val": "当地居民 / 骑行者 / 步行者 / 周边社区 / 休闲游客", "rel-status-val": "学术项目 / 概念提案", "rel-statement": "RE:LINE 以米兰南部一条废弃铁路为线性骨架，将其转化为连接城市社区、农业景观与开放空间的生态文化廊道。项目通过连续的步行和骑行网络重新缝合被基础设施割裂的城乡边缘，同时保留旧铁路的空间记忆。原有采石湖被改造为核心休闲节点，结合亲水空间、社区花园、湿地生境与公共活动场地。沿线设计采用可复制、可调整的景观模块，以适应不同的城市和乡村环境，使废弃基础设施重新成为具有公共价值的绿色网络。", "rel-cap-1": "将废弃铁轨转化为具有生命力的线性景观。", "rel-cap-2": "慢行廊道重新连接破碎的城乡景观。", "rel-cap-3": "铁路遗迹、生态缓冲带与公共节点共同构成线性网络。", "rel-cap-4": "废弃采石湖转化为开放共享的休闲景观。", "rel-cap-5": "活力滨水空间逐步过渡为修复后的湿地生境。", "rel-cap-6": "可复制模块使廊道适应沿线不同空间条件。",

        // --- P07: Orba River Sustainability ---
        "ors-meta": "区域景观规划 / 2025年1月", "ors-title": "奥尔巴河流域可持续更新", "ors-loc-val": "意大利皮埃蒙特大区亚历山德里亚省，奥尔巴河流域", "ors-type-val": "区域景观规划 / 生态修复 / 河岸公共空间设计", "ors-user-val": "当地居民 / 河岸社区 / 游客 / 骑行者 / 农业社区", "ors-status-val": "学术项目 / 概念提案", "ors-statement": "Orba River Sustainability 是一项面向奥尔巴河流域的区域景观规划。项目回应栖息地破碎化、洪水风险、农业生产压力以及采砂遗留场地等问题，通过连续的蓝绿基础设施重建河岸地区的生态基底。设计将洪泛区修复、植被恢复、公共休闲空间与慢行网络结合起来，使河流景观与周边社区重新建立联系。区域尺度的策略进一步落实为三个具有代表性的节点：废弃采砂场改造、城镇入口公园以及贯穿居住区的内部绿色廊道。", "ors-cap-1": "以蓝绿框架重新连接河流、城镇与农业景观。", "ors-cap-2": "区域廊道串联河流生态、农业景观与周边聚落。", "ors-cap-3": "从河流动态推演至连续的景观策略。", "ors-cap-4": "废弃采砂场转化为修复后的河岸景观。", "ors-cap-5": "新的入口公园重新连接城镇与农业边界。", "ors-cap-6": "生态网络延伸至社区的日常公共空间。"
    }
};
